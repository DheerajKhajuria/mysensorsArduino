...
{ 
  ...
  gw.sendSketchInfo("LPG Sensor Temp Sensor", "1.0");
...
void computeMQ6()
{
  ...
  if(valMQ > 20 ) // alteast 20 ppm to buzz.
  {
...
Remarks: This function assumes that the sensor is in clean air. It use  
         ...
         and then divides it with RO_CLEAN_AIRtt      _FACTOR. RO_CLEAN_AIR_FACTOR is about 
...
v         by changing the definition of the macros.
************************************************************************************/ 
