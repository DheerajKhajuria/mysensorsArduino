...
void setup()
{
  ...
  pinMode(DIGITAL_INPUT_SENSOR, INPUT);     // sets the motion sensor digital pin as input
   pinMode(5, OUTPUT);     // sets the motion sensor digital pin as input
   pinMode(8, OUTPUT);     // sets the motion sensor digital pin as input
...
void loop()
{
  ...
  lightLevel = (analogRead(LIGHT_SENSOR_ANALOG_PIN)); 
...
void check_batt()
{
  ...
  float batteryV  = ( sensorValue * 0.003919844 ) ; // divide R2/(R1+R2)
