...
void setup() {
  ...
  attachInterrupt(1, rxIR_Interrupt_Handler, CHANGE);//set up ISR for receiving IR signal
}
...
void loop() {
  ...
  if (x) { //if a signal is captured
    ...
    attachInterrupt(1, rxIR_Interrupt_Handler, CHANGE);//re-enable ISR for receiving IR signal
  }
